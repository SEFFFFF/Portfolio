...
<body>
    ...
    <div class="container">
        ...
        <div class="row animated fade-down delay-400">
            <div class="project">
                <div class="overlay" onclick="location.href='intercultural awareness.php'">                       
                   <h1>Intercultural Awareness</h1>
                </div>
                <img src="images/Asset 30.png" alt="Avatar" class="image">
            </div>
            <div class="project">
                <div class="overlay" onclick="location.href='branding.php'">                       
                   <h1>Branding</h1>
                </div>
            ...
            <div class="project">
                <div class="overlay" onclick="location.href='apa opdracht.php'">                       
                   <h1>APA Opdracht</h1>
                </div>
